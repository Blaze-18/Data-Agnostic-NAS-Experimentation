...
def load_ground_truth_accuracy(arch_data_dir: str = 'data/nasbench201/chunks_clean/arch2infos', 
                               dataset: str = 'cifar10', 
...
def validate_rankings(output_dir: str = 'results/nasbench201/proxy_validation',
                    arch_data_dir: str = 'data/nasbench201/chunks_clean/arch2infos',
                    proxy_scores_dir: str = 'results/nasbench201/raw_proxy_scores',
