...
Output:
  - results/nasbench201/proxy_distribution/stats_summary.json
  - results/nasbench201/proxy_distribution/distribution_plots.png (histograms, KDE, box plots)
"""
...
def analyze_distributions(output_dir: str = 'results/nasbench201/proxy_distribution'):
    """
    ...
    proxy_scores_dir = 'results/nasbench201/raw_proxy_scores'
    transformed_dir = 'results/nasbench201/transformed_proxy'
