"""
Pilot: NASWOT proxy on first N_PILOT=20,000 architectures.
Estimated time: ~15 min.
Output: results/nasbench101/pilot_test/raw_proxy_scores/naswot.npy  shape (20000,)
"""
...
def main():
    ...
    t0 = time.time()
    print(f"Computing NASWOT on {N_PILOT} architectures ...", flush=True)
    ...
    np.save(OUT_DIR / "naswot.npy", scores)
    print(f"Done in {time.time()-t0:.0f}s.  Saved naswot.npy  "
